...
Gave a total of {g} roles."""
    ...
    def __init__(self, bot: discord.Client):
        self.bot = bot
        self.logger = logging.getLogger("GRR")
        self.check_configs()
        self.load_data()
    ...
    @GRR.command(name="linklist", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
    ...
    @GRR.command(name="unlink", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
    ...
    @GRR.command(name="link", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
    ...
    @GRR.command(name="add", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
    ...
    @GRR.command(name="remove", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
    ...
    @GRR.command(name="check", pass_context=True, no_pm=True)
    @checks.mod_or_permissions(manage_roles=True)
