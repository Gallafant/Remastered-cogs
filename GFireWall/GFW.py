...
class GFireWall:
    def __init__(self, bot):
        ...
        self.settings_file = 'data/GFireWall/settings.json'
        self.settings = dataIO.load_json(self.settings_file)
        self.ignore_file = 'data/GFireWall/ignore.json'
...
def check_folder():
    if not os.path.exists('data/GFireWall'):
        print('Creating data/GFireWall folder...')
        os.makedirs('data/GFireWall')
...
def check_file():
    ...
    settings_file = 'data/GFireWall/settings.json'
    ignore_file = 'data/GFireWall/ignore.json'
