...
class GOA():
    ...
    def __init__(self, bot):
        self.bot = bot
        self.settings_file = "data/GOA/settings.json"
        self.log_file = "data/GOA/log.json"
    ...
    async def GOA(self, ctx):
        """Setup an activity checker channel"""
        if ctx.invoked_subcommand is None:
            await self.bot.send_cmd_help(ctx)

    @GOA.command(pass_context=True, name="list")
    ...
    @GOA.command(pass_context=True, name="next")
    ...
    @GOA.command(pass_context=True, name="remove")
    ...
    @GOA.command(pass_context=True, name="role")
    ...
    @GOA.command(pass_context=True, name="invite")
    ...
    @GOA.command(pass_context=True, name="link")
    ...
    @GOA.command(pass_context=True, name="time")
    ...
    @GOA.command(pass_context=True, name="channel")
    ...
    @GOA.command(pass_context=True, name="set")
    ...
    async def activity_checker(self):
        ...
        while self is self.bot.get_cog("GOA"):
...
def check_folder():
    if not os.path.exists("data/GOA"):
        print("Creating data/GOA folder")
        os.makedirs("data/GOA")


def check_file():
    data = {}
    log = "data/GOA/log.json"
    if not dataIO.is_valid_json(log):
        print("Creating default log.json...")
        dataIO.save_json("data/GOA/log.json", data)
    settings = "data/GOA/settings.json"
    if not dataIO.is_valid_json(settings):
        print("Creating default settings.json...")
        dataIO.save_json("data/GOA/settings.json", data)
